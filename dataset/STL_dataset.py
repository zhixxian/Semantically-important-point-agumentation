...
def get_STL10_dataloader(args):
    ...
    if args.augmentation == 'baseline':
        print("Augmentation Apply baseline")
    ...
    train_loader = torch.utils.data.DataLoader(
        STL10(
            ...
            transform=transform_train, args=args), shuffle=True,
            batch_size=args.batch_size, num_workers=args.workers, pin_memory=True)

    test_loader = torch.utils.data.DataLoader(
        STL10(
            root='../data', split='test', download=True,
            transform=transform_test, args=args), shuffle = False,
            batch_size=args.batch_size, num_workers=args.workers, pin_memory=True)
