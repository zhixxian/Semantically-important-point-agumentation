...
from dataset.data.VanillaBackprop import VanillaBackprop, convert_to_grayscale
...
class CIFAR10(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=True, args= None):
